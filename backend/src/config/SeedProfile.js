...
const creatorData = [
...

  {
    ...
    avatarUrl:
      "https://api.dicebear.com/9.x/avataaars/svg?seed=Piyush",
...

  {
    ...
    avatarUrl:
      "https://api.dicebear.com/9.x/avataaars/svg?seed=Shweta",
...

  {
    ...
    avatarUrl:
      "https://api.dicebear.com/9.x/avataaars/svg?seed=Nandita",
...

  {
    ...
    avatarUrl:
      "https://api.dicebear.com/9.x/avataaars/svg?seed=Kashish",
...

  {
    ...
    avatarUrl:
      "https://api.dicebear.com/9.x/avataaars/svg?seed=Kanika",
...

  {
    ...
    avatarUrl:
      "https://api.dicebear.com/9.x/avataaars/svg?seed=Aarya",
...

  {
    ...
    avatarUrl:
      "https://api.dicebear.com/9.x/avataaars/svg?seed=Rahul",
...

  {
    ...
    avatarUrl:
      "https://api.dicebear.com/9.x/avataaars/svg?seed=Meera",
...
const brandData = [
  {
    ...
    avatarUrl:
      "https://api.dicebear.com/9.x/avataaars/svg?seed=Hawai",
...

  {
    ...
    avatarUrl:
      "https://api.dicebear.com/9.x/avataaars/svg?seed=Xpandia",
...

  {
    ...
    avatarUrl:
      "https://api.dicebear.com/9.x/avataaars/svg?seed=Aman",
...

  {
    ...
    avatarUrl:
      "https://api.dicebear.com/9.x/avataaars/svg?seed=HawaHawai",
...

  {
    ...
    avatarUrl:
      "https://api.dicebear.com/9.x/avataaars/svg?seed=Nakshaa",
...

  {
    ...
    avatarUrl:
      "https://api.dicebear.com/9.x/avataaars/svg?seed=KashishFashion",
...

  {
    ...
    avatarUrl:
      "https://api.dicebear.com/9.x/avataaars/svg?seed=NikeIndia",
...

  {
    ...
    avatarUrl:
      "https://api.dicebear.com/9.x/avataaars/svg?seed=Zomato",
